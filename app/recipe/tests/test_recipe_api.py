...
"""
Create helper function to create more users for the test.
"""
...
class PublicRecipeApiTests(TestCase):
    """Test unauthenicated API requests."""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe(self):
        ...
        """Pass the post request to the payload to this endpoint """
        """api/recipes/recipe"""
        res = self.client.post(RECIPES_URL, payload)

        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        recipe = Recipe.objects.get(id=res.data['id'])
        """k=key(Title), v=value(Result assigned to the Title)"""
    ...
    def test_create_recipe_with_new_tags(self):
        """Test creting a recipe with new tags."""
        payload = {
...
class ImageUploadTest(TestCase):
    ...
    def tearDown(self):
        """Runs after the test to avoid building test images
        on machine when running test case"""
        self.recipe.image.delete()

    def test_upload_image(self):
        """Test uploading an image to a recipe."""
        url = image_upload_url(self.recipe.id)
        """Create a temporary helper module provided by python """
